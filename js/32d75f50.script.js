...
;
//"use strict";var directives=angular.module("directives",[]);
/*PROD*/
"use strict";var directives=angular.module("training.editor",['templates-directives']);;
'use strict';
...
directives.directive('buttonValid', function() {
	return {
		templateUrl : 'editor/templates/button-valid.html',
		restrict : 'E',
